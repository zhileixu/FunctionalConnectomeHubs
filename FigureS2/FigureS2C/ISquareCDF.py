...
ISquare = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS2\FigureS2C\ISquare.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\FigureS2\FigureS2C\ISquareCDF.pdf")
