...
ISquareCDF = pandas.read_csv(r"\FunctionalConnectomeHubs\SupplementaryFigure1\ISquare.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\SupplementaryFigure\ISquareCDFSeparate.pdf")
