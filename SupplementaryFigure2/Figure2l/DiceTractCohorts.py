...
DiceTract = pandas.read_csv( r"\FunctionalConnectomeHubs\SupplementaryFigure2\Figure2l\DiceAcrossRandomlySelectedCohorts.csv", header=None )
...
fig.savefig( r"\FunctionalConnectomeHubs\SupplementaryFigure2\Figure2l\DiceTractCohorts.pdf" )
