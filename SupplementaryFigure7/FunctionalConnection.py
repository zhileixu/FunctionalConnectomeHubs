...
for Hub in range(1, 36):
    ...
    WeakConnection = pandas.read_csv(r"\FunctionalConnectomeHubs\SupplementaryFigure7\FunctionalConnection_Hub%02d.csv"%(Hub), header=None)
    ...
    fig.savefig(r"\FunctionalConnectomeHubs\SupplementaryFigure7\FunctionalConnection_Hub%02d.tiff"%(Hub), dpi=600)