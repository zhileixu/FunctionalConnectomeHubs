...
NetworkSize = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS4\NetworkSize.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\FigureS4\NetworkSize3.tiff", dpi=600)
