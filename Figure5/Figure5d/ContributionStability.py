...
ContributionStability = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5d\ContributionStability.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\Figure5\Figure5d\ContributionStability.pdf")
