...
NeuronDifferentiation = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-NeuronDifferentiation-Hub.csv", header=None)
...
NeuronDifferentiation = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-NeuronDifferentiation-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(NeuronDifferentiation.loc[0].values, NeuronDifferentiation.loc[1].values, frac=0.1)
seaborn.lineplot(x=xout, y=yout, linewidth=0.8, color="tab:blue", linestyle='--', ci=None)


NeuronMigration = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-NeuronMigration-Hub.csv", header=None)
...
NeuronMigration = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-NeuronMigration-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(NeuronMigration.loc[0].values, NeuronMigration.loc[1].values, frac=0.1)
...
fig.savefig(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-1.tiff", dpi=600)
