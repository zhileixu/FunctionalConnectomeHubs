...
DendriteDevelopment = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-DendriteDevelopment-Hub.csv", header=None)
...
DendriteDevelopment = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-DendriteDevelopment-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(DendriteDevelopment.loc[0].values, DendriteDevelopment.loc[1].values, frac=0.1)
seaborn.lineplot(x=xout, y=yout, linewidth=0.8, color="tab:green", linestyle='--', ci=None)


SynapseDevelopment = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-SynapseDevelopment-Hub.csv", header=None)
...
SynapseDevelopment = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-SynapseDevelopment-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(SynapseDevelopment.loc[0].values, SynapseDevelopment.loc[1].values, frac=0.1)
...
fig.savefig(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-2.tiff", dpi=600)
