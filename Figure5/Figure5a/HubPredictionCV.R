...
Hub <- read.table( "\\FunctionalConnectomeHubs\\Figure5\\Figure5a\\Hub1158.csv", header = FALSE, sep = ',' )
HubTrain <- read.table( "\\FunctionalConnectomeHubs\\Figure5\\Figure5a\\Hub1158Train.csv", header = FALSE, sep = ',' )
HubTest <- read.table( "\\FunctionalConnectomeHubs\\Figure5\\Figure5a\\Hub1158Test.csv", header = FALSE, sep = ',' )

Fold <- 30
Step <- 0.05
OutputPath <- paste( "\\FunctionalConnectomeHubs\\Figure5\\Figure5a\\CV", sprintf( "%02d", Fold ), "Fold", sep="" )
