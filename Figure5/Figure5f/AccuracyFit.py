...
Accuracy = pandas.read_csv( r"\FunctionalConnectomeHubs\Figure5\Figure5f\AccuracyFit.csv", header=None )
...
fig.savefig( r"\FunctionalConnectomeHubs\Figure5\Figure5f\AccuracyFit.pdf" )
