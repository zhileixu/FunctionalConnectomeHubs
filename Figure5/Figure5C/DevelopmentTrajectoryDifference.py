...
for Process in ["NeuronDifferentiation", "NeuronMigration", "DendriteDevelopment", "SynapseDevelopment", "AxonDevelopment", "Myelination", "OP", "AG"]:
    ...
    MAD = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure5\Figure5B\DevelopmentTrajectory-%s-MAD.csv"%Process, header=None)
    ...
    fig.savefig(r"\FunctionalConnectomeHubs\Figure5\Figure5C\DevelopmentTrajectoryDifference-%s.pdf"%Process)