...
ISquare = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure2\Figure2C\ISquare.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\Figure2\Figure2C\ISquareCDF.pdf")
