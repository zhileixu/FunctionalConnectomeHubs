...
DiceTract = pandas.read_csv( r"\FunctionalConnectomeHubs\Figure2\Figure2h\DiceAcrossRandomlySelectedCohorts.csv", header=None )
...
fig.savefig( r"\FunctionalConnectomeHubs\Figure2\Figure2h\DiceTractCohorts.tiff", dpi=600 )
