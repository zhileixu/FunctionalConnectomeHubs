...
ISquare = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure2\Figure2b\ISquare.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\Figure2\Figure2b\ISquareCDF.pdf")
