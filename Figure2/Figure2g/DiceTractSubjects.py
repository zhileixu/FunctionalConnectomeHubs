...
DiceTract = pandas.read_csv( r"\FunctionalConnectomeHubs\Figure2\Figure2g\DiceAcrossRandomlySelectedSubjects.csv", header=None )
...
fig.savefig( r"\FunctionalConnectomeHubs\Figure2\Figure2g\DiceTractSubjects.pdf" )
