...
for Process in ["NeuronDifferentiation", "NeuronMigration", "DendriteDevelopment", "SynapseDevelopment", "AxonDevelopment", "Myelination", "OP", "AG"]:
    Data = pandas.read_csv(r"\FunctionalConnectomeHubs\SupplementaryFigure9\Figure9a\DevelopmentTrajectoryNeocortex-%s-Data.csv"%Process, header=None)
    MAD = pandas.read_csv(r"\FunctionalConnectomeHubs\SupplementaryFigure9\Figure9a\DevelopmentTrajectoryNeocortex-%s-MAD.csv"%Process, header=None)
    ...
    fig.savefig(r"\FunctionalConnectomeHubs\SupplementaryFigure9\Figure9b\DevelopmentTrajectoryNeocortexDifference-%s.pdf"%Process)