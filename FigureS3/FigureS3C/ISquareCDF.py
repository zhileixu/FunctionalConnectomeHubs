...
ISquare = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS3\FigureS3C\ISquare.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\FigureS3\FigureS3C\ISquareCDF.pdf")
