...
DiceTract = pandas.read_csv( r"\FunctionalConnectomeHubs\FigureS3\FigureS3F\DiceAcrossRandomlySelectedCohorts.csv", header=None )
...
fig.savefig( r"\FunctionalConnectomeHubs\FigureS3\FigureS3F\DiceTractCohorts.tiff", dpi=600 )
