...
DiceTract = pandas.read_csv( r"\FunctionalConnectomeHubs\FigureS3\FigureS3F\DiceAcrossRandomlySelectedSubjects.csv", header=None )
...
fig.savefig( r"\FunctionalConnectomeHubs\FigureS3\FigureS3F\DiceTractSubjects.tiff", dpi=600 )
