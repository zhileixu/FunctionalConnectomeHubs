...
for Process in ["NeuronDifferentiation", "NeuronMigration", "DendriteDevelopment", "SynapseDevelopment", "AxonDevelopment", "Myelination", "OP", "AG"]:
    Data = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS9\FigureS9A\DevelopmentTrajectoryNeocortex-%s-Data.csv"%Process, header=None)
    MAD = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS9\FigureS9A\DevelopmentTrajectoryNeocortex-%s-MAD.csv"%Process, header=None)
    ...
    fig.savefig(r"\FunctionalConnectomeHubs\FigureS9\FigureS9B\DevelopmentTrajectoryNeocortexDifference-%s.pdf"%Process)