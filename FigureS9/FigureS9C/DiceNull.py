...
DiceNull = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS9\FigureS9C\DiceNull.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\FigureS9\FigureS9C\DiceNull.tiff", dpi=600)
