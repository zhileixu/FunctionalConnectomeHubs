...
GSL = spm_vol( '\FunctionalConnectomeHubs\FigureS9\FigureS9B\GSL.nii' );
GSL = spm_read_vols( GSL );
GSL = GSL( MaskIndex )

Hub = spm_vol( '\FunctionalConnectomeHubs\FigureS9\FigureS9A\ZValue_P0.001_ClusterSize200_Mask.nii' );
...
dlmwrite( '\FunctionalConnectomeHubs\FigureS9\FigureS9C\DiceNull.csv', DiceNull, 'delimiter',',','precision','%.6f')
