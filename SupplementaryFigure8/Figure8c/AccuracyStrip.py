...
Accuracy = pandas.read_csv(r"FunctionalConnectomeHubs\SupplementaryFigure8\Figure8c\Accuracy.csv", header=None)
...
fig.savefig(r"FunctionalConnectomeHubs\SupplementaryFigure8\Figure8c\AccuracyStrip.pdf")
