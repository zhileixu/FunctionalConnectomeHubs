...
Hub <- read.table( "\\FunctionalConnectomeHubs\\SupplementaryFigure8\\Figure8a\\Hub1158_Surrogate.csv", header = FALSE, sep = ',' )
HubTrain <- read.table( "\\FunctionalConnectomeHubs\\SupplementaryFigure8\\Figure8a\\Hub1158Train_Surrogate.csv", header = FALSE, sep = ',' )
HubTest <- read.table( "\\FunctionalConnectomeHubs\\SupplementaryFigure8\\Figure8a\\Hub1158Test_Surrogate.csv", header = FALSE, sep = ',' )

Fold <- 30
Step <- 0.05
OutputPath <- paste( "\\FunctionalConnectomeHubs\\SupplementaryFigure8\\Figure8a\\CV", sprintf( "%02d", Fold ), "Fold", sep="" )
