...
GSL = spm_vol( '\FunctionalConnectomeHubs\SupplementaryFigure10\Figure10b\GSL.nii' );
GSL = spm_read_vols( GSL );
GSL = GSL( MaskIndex )

Hub = spm_vol( '\FunctionalConnectomeHubs\SupplementaryFigure10\Figure10a\ZValue_P0.001_ClusterSize200_Mask.nii' );
...
dlmwrite( '\FunctionalConnectomeHubs\SupplementaryFigure10\Figure10C\c\DiceNull.csv', DiceNull, 'delimiter',',','precision','%.6f')
