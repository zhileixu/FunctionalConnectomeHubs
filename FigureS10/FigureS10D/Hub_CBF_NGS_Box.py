...
Hub_Metabolism = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS10\FigureS10D\Hub_Metabolism_NGS.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\FigureS10\FigureS10D\Hub_CBF_NGS_Box.pdf")
