...
ISquare = pandas.read_csv(r"\FunctionalConnectomeHubs\SupplementaryFigure3\Figure3f\ISquare.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\SupplementaryFigure3\Figure3f\ISquareCDF.pdf")
