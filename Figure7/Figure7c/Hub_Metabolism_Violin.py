...
Hub_Metabolism = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure7\Figure7c\Hub_Metabolism.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\Figure7\Figure7c\Hub_AG_Violin.pdf")
...
fig.subplots_adjust(left=0, bottom=0, right=1, top=1)
fig.savefig(r"\FunctionalConnectomeHubs\Figure7\Figure7c\Hub_CMRO2_Violin.pdf")
...
fig.subplots_adjust(left=0, bottom=0, right=1, top=1)
fig.savefig(r"\FunctionalConnectomeHubs\Figure7\Figure7c\Hub_CBF_Violin.pdf")
