...
AxonDevelopment = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-AxonDevelopment-Hub.csv", header=None)
...
AxonDevelopment = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-AxonDevelopment-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(AxonDevelopment.loc[0].values, AxonDevelopment.loc[1].values, frac=0.1)
seaborn.lineplot(x=xout, y=yout, linewidth=0.8, color="tab:purple", linestyle='--', ci=None)


Myelination = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-Myelination-Hub.csv", header=None)
...
Myelination = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-Myelination-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(Myelination.loc[0].values, Myelination.loc[1].values, frac=0.1)
...
fig.savefig(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-3.tiff", dpi=600)
