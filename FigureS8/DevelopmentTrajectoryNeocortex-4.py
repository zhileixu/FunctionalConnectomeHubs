...
OP = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-OP-Hub.csv", header=None)
...
OP = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-OP-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(OP.loc[0].values, OP.loc[1].values, frac=0.1)
seaborn.lineplot(x=xout, y=yout, linewidth=0.8, color="darkcyan", linestyle='--', ci=None)

AG = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-AG-Hub.csv", header=None)
...
AG = pandas.read_csv(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-AG-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(AG.loc[0].values, AG.loc[1].values, frac=0.1)
...
fig.savefig(r"\FunctionalConnectomeHubs\FigureS8\DevelopmentTrajectoryNeocortex-4.tiff", dpi=600)
