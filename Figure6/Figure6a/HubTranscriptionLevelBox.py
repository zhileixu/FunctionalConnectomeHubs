...
HubTranscriptionLevel = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure6\Figure6a\HubTranscriptionLevel.csv", header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\Figure6\Figure6a\HubTranscriptionLevelBox.pdf")
