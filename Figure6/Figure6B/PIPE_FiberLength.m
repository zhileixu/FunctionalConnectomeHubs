...
FiberLength = ft_read_cifti( '\FunctionalConnectomeHubs\Figure6\iFOD2.76.mean-length-maps.dscalar.nii' );
...
%%
Surf.L = gifti( '\FunctionalConnectomeHubs\Figure6\average.76.L.midthickness.surf.gii' );
Surf.R = gifti( '\FunctionalConnectomeHubs\Figure6\average.76.R.midthickness.surf.gii' );
...
Hub = spm_vol( '\FunctionalConnectomeHubs\Figure2\Figure2B\ZValue_P0.001_ClusterSize200_Mask.nii' );
...
%csvwrite( '\FunctionalConnectomeHubs\Figure6\FiberNumber.csv', [ [ ones( 1, sum( HubVertex ) ), zeros( 1, sum( NonHubVertex ) ) ]; ...
...
save( '\FunctionalConnectomeHubs\Figure6\RankSumP.mat', 'RankSum_Raw', 'RankSum_Null', 'RankSumP' );