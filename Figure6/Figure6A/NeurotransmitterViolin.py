...
for Neurotransmitter in [ "GABAa_FLUMAZENIL_c11", "mGluR5_abp_hc73_smart", "MU_carfentanil_hc39_turtonen", 
    ...
    Data = pandas.read_csv(r"\FunctionalConnectomeHubs\Figure6\Figure6A\%s.csv"%Neurotransmitter, header=None)
...
fig.savefig(r"\FunctionalConnectomeHubs\Figure6\Figure6A\NeurotransmitterViolin.pdf")
