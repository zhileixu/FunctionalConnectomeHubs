...
Accuracy = pandas.read_csv( r"\FunctionalConnectomeHubs\Figure4\Figure4G\AccuracyFit.csv", header=None )
...
fig.savefig( r"\FunctionalConnectomeHubs\Figure4\Figure4G\AccuracyFit.tiff", dpi=600 )
